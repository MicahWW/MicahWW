    ...
    return (
        <>
            <div id="overview" className={gStyles.hiddenInPrint}>
                ...
                <p>Below you will find an online resume of sorts, it has an <a href="#about">intro about my work</a>, my previous <a href="#workExperience">Work Experience</a>, <a href="#projects">Projects</a>, <a href="#education">Education</a>, and <a href="#skills">Skills</a>. Above you will find links to some of my external profiles and the source code to this page.</p>
